...
/* inputs: light grey box, thin border, dark text */
div[data-baseweb="select"] > div, div[data-baseweb="input"], div[data-baseweb="base-input"] {
    background:#F2F2F2 !important; border:1px solid #cfcfcf !important; border-radius:2px !important;
    min-height:40px;}
div[data-baseweb="select"] *, div[data-baseweb="input"] input {color:#111 !important;
    -webkit-text-fill-color:#111 !important; font-size:.9rem;}
div[data-baseweb="input"] button {background:#F2F2F2 !important; color:#111 !important;}
span[data-baseweb="tag"] {background:#dfe6f2 !important; border-radius:2px !important;}
span[data-baseweb="tag"] * {color:#1F3864 !important; -webkit-text-fill-color:#1F3864 !important;}
