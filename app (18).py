...
st.markdown("""
<style>
.stApp, [data-testid="stAppViewContainer"], [data-testid="stHeader"] {background:#fff !important;}
.block-container {max-width: 760px; padding-top: 2.5rem;}
html, body, .stApp, p, span, label, div {color:#111;}
.title-bar {background:#1F3864; color:#fff !important; text-align:center; font-weight:700;
            font-size:1.1rem; padding:16px; margin-bottom:28px;}
.lbl {font-weight:700; font-size:.9rem; color:#111 !important; margin:0;}
div[data-testid="stHorizontalBlock"] {margin-bottom:.4rem; align-items:center;}
/* inputs: light grey box, thin border, dark text (works even if dark theme is active) */
div[data-baseweb="select"] > div, div[data-baseweb="input"], div[data-baseweb="base-input"] {
    border:1px solid #bdbdbd !important; border-radius:2px !important; min-height:40px;}
div[data-baseweb="select"] *, div[data-baseweb="input"] *, div[data-baseweb="base-input"] *,
[data-testid="stNumberInput"] * {
    background-color:#F2F2F2 !important; color:#111 !important;
    -webkit-text-fill-color:#111 !important; font-size:.92rem;}
div[data-baseweb="select"] svg, div[data-baseweb="input"] svg {fill:#111 !important;}
div[data-baseweb="select"] span[data-baseweb="tag"], div[data-baseweb="select"] span[data-baseweb="tag"] * {
    background-color:#DCE4F2 !important; color:#1F3864 !important;
    -webkit-text-fill-color:#1F3864 !important; border-radius:2px !important;}
div[data-baseweb="select"] span[data-baseweb="tag"] svg {fill:#1F3864 !important;}
/* dropdown list (opens in a popover outside the form) */
div[data-baseweb="popover"], div[data-baseweb="popover"] *, ul[role="listbox"], ul[role="listbox"] * {
    background-color:#fff !important; color:#111 !important; -webkit-text-fill-color:#111 !important;}
div[data-baseweb="popover"] { border:1px solid #bdbdbd !important; border-radius:2px !important;
...
div[data-baseweb="popover"] li[aria-selected="true"], div[data-baseweb="popover"] li[aria-selected="true"] * {
    background-color:#E6ECF5 !important; color:#1F3864 !important; -webkit-text-fill-color:#1F3864 !important;}
/* full-width green button */
div.stButton {width:100% !important;}
div.stButton > button {background:#2E7D32 !important; color:#fff !important; width:100% !important;
    font-weight:700; border:none; border-radius:2px; padding:.75rem 0; margin-top:12px;}
div.stButton > button p {color:#fff !important;}
div.stButton > button:hover {background:#256628 !important;}
.result {background:#EAF1FB; border:1.5px solid #1F3864; text-align:center; padding:16px;
         margin-top:24px;}
.result .s {font-size:.85rem; color:#333 !important;}
.result .v {font-size:1.9rem; font-weight:800; color:#1F3864 !important;}
